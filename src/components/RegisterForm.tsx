...
export const RegisterForm: React.FC = () => {
  ...
  return <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        ...
        <input id="name" type="text" required value={name} onChange={e => setName(e.target.value)} className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500" />
      </div>
      <div>
